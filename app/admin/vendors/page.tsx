  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button className="text-white gap-2 shadow-md shadow-violet-400/30" style={{ background: 'linear-gradient(135deg, #7C3AED 0%, #9333EA 100%)' }}>
          <Store size={18} />
          Onboard New Vendor
        </Button>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-violet-100/80 bg-white p-4 shadow-sm dark:border-violet-900/20 dark:bg-zinc-950">
      ...
      <div className="rounded-2xl border border-violet-100/80 bg-white shadow-sm dark:border-violet-900/20 dark:bg-zinc-950">
        <div className="p-4 border-b border-violet-100/80 dark:border-violet-900/20 flex items-center justify-between">
            ...
            <tbody className="divide-y divide-violet-50 dark:divide-violet-900/10">
              {loading ? (
                ...
                filteredVendors.map((vendor) => (
                  <tr key={vendor.id} className="group hover:bg-violet-50/40 dark:hover:bg-violet-900/10">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-lg font-bold uppercase shrink-0 text-white shadow-sm shadow-violet-400/30"
                    ...
                    <td className="px-6 py-4">
                      <span className={cn(
                        ...
                        vendor.status?.toLowerCase() === 'pending' ? "bg-pink-50 text-pink-600 dark:bg-pink-900/20" :
