    ...
    <div className="relative flex min-h-[85vh] items-center justify-center overflow-hidden px-4 py-6 sm:py-12">
      ...
      <div className="w-full max-w-md overflow-hidden rounded-[2rem] border border-zinc-200/60 bg-white/70 p-6 shadow-2xl backdrop-blur-xl dark:border-zinc-800/60 dark:bg-zinc-900/70 dark:shadow-none sm:p-10">
        <div className="mb-6 text-center">
          {isSignUp ? (
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center select-none w-full -mt-4 -mb-2 md:-mt-8 md:-mb-6">
                <img src="/mimo-x-light.png" alt="MIMO X Logo" className="w-40 md:w-48 h-auto object-contain block dark:hidden mix-blend-multiply" />
                <img src="/mimo-x-dark.png" alt="MIMO X Logo" className="w-40 md:w-48 h-auto object-contain hidden dark:block" />
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center justify-center select-none w-full -mt-6 -mb-4 md:-mt-10 md:-mb-6">
                <img src="/mimo-x-light.png" alt="MIMO X Logo" className="w-40 md:w-48 h-auto object-contain block dark:hidden mix-blend-multiply" />
                <img src="/mimo-x-dark.png" alt="MIMO X Logo" className="w-40 md:w-48 h-auto object-contain hidden dark:block" />
              </div>
            </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3 sm:space-y-4">
          ...
          <Button
            type="submit"
            className="w-full h-11 sm:h-12 rounded-2xl font-bold mt-2"
            disabled={loading || googleLoading}
          >
            {loading ? (
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-11 sm:h-12 rounded-2xl font-bold gap-2 sm:gap-3 border-zinc-200 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800/50"
        ...
        <p className="mt-6 sm:mt-8 text-center text-xs sm:text-sm font-medium text-zinc-500 dark:text-zinc-400">
