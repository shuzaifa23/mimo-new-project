      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-zinc-500 font-medium">Manage incoming print orders and update their status directly.</p>
          </div>
        ...
        {/* Search Bar */}
        <div className="mb-6 flex max-w-md h-12 items-center gap-2 rounded-2xl bg-white px-4 shadow-sm dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={i} className={`rounded-[1.5rem] p-6 shadow-sm ${stat.color}`}>
              <p className="text-xs font-bold uppercase tracking-wider opacity-85">{stat.label}</p>
                      ...
                      <tr key={order.id} className="group hover:bg-zinc-50/50 dark:hover:bg-zinc-900/30 transition-colors">
                        <td className="px-6 py-6">
                          <div>
                            ...
                            <p className="text-xs text-zinc-500 font-medium">{order.phone || 'No phone'}</p>
                            <p className="mt-1 text-[10px] text-zinc-400 font-semibold">
                        ...
                        <td className="px-6 py-6">
                          ...
                          <p className="text-[10px] font-black text-green-600 uppercase tracking-wider">{order.payment_status}</p>
                        </td>
                        <td className="px-6 py-6">
                          ...
                          <div className="flex items-center justify-end gap-2">
                            {order.file_url && (
                              <div className="flex items-center gap-2">
                                ...
                                <button 
                                  onClick={() => triggerVendorWhatsApp(order)}
